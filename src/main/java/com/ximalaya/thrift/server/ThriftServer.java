/*
 * 文件名称: SpringThriftServer.java Copyright 2011-2013 Nali All right reserved.
 */
 ...
 * And help user auto start thrift server.
 * <p>
 * User would only configure some properties in spring application context xml file.
 * 
 * @author ted wang
 * @author gavin lu
 * @since 1.0
